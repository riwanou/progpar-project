...
SimulationNBodySimdOMPNaive::SimulationNBodySimdOMPNaive(const unsigned long nBodies, const std::string &scheme, const float soft,
...
void SimulationNBodySimdOMPNaive::initIteration()
{
...
void SimulationNBodySimdOMPNaive::computeBodiesAcceleration()
{
    ...
    #pragma omp parallel \
				for schedule(dynamic, this->getBodies().getN() / 60 + 1) \
...
void SimulationNBodySimdOMPNaive::computeOneIteration()
{
    this->initIteration();
