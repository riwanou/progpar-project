...
void test_nbody_optim1_approx(const size_t n, const float soft, const float dt, const size_t nIte, const std::string &scheme,
                     const float eps)
{
...
TEST_CASE("n-body - Optim1 Approx", "[optim1_approx]")
{
    ...
    SECTION("fp32 - n=16 - i=1 - random") { test_nbody_optim1_approx(16, 2e+08, 3600, 1, "random", 1e-3); }
    SECTION("fp32 - n=128 - i=1 - random") { test_nbody_optim1_approx(128, 2e+08, 3600, 1, "random", 1e-3); }
    SECTION("fp32 - n=2048 - i=1 - random") { test_nbody_optim1_approx(2048, 2e+08, 3600, 1, "random", 1e-3); }
    SECTION("fp32 - n=2049 - i=3 - random") { test_nbody_optim1_approx(2049, 2e+08, 3600, 3, "random", 1e-3); }

    SECTION("fp32 - n=13 - i=1 - galaxy") { test_nbody_optim1_approx(13, 2e+08, 3600, 1, "galaxy", 1e-1); }
    SECTION("fp32 - n=13 - i=30 - galaxy") { test_nbody_optim1_approx(13, 2e+08, 3600, 30, "galaxy", 1e-1); }
    SECTION("fp32 - n=16 - i=1 - galaxy") { test_nbody_optim1_approx(16, 2e+08, 3600, 1, "galaxy", 1e-2); }
    SECTION("fp32 - n=128 - i=1 - galaxy") { test_nbody_optim1_approx(128, 2e+08, 3600, 1, "galaxy", 1e-2); }
    SECTION("fp32 - n=2048 - i=4 - galaxy") { test_nbody_optim1_approx(2048, 2e+08, 3600, 4, "galaxy", 1e-1); }
    SECTION("fp32 - n=2049 - i=3 - galaxy") { test_nbody_optim1_approx(2049, 2e+08, 3600, 3, "galaxy", 1e-1); }
